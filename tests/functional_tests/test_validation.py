...
class TestMain:
    ...
    def test_validation_method_is_mandatory(self):
        ...
        with pytest.raises(KeyError):
            validation_ = validation.AbstractValidation(**{"something's wrong": "b"})
    ...
    def test_fails_with_invalid_method(self):
        ...
        """
        with pytest.raises(KeyError):
            validation_ = validation.AbstractValidation(**{"validation_method": "hello"})
    ...
    def test_right_instance_created(self):
        ...
        """
        validation_ = validation.AbstractValidation(**{"validation_method": "cross_checking_fast"})
        ...
        validation_ = validation.AbstractValidation(**{"validation_method": "cross_checking_accurate"})
        assert isinstance(validation_, validation.AbstractValidation)
