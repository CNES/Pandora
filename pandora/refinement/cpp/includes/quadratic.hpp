...
/*
This module contains functions associated to the Quadratic Refinement algorithms in cpp.
*/
...
/**
 * @brief Returns the subpixel disparity and cost by fitting a quadratic curve.
 *
